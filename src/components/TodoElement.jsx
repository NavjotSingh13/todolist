...
const TodoElement = ({ item, toggleCompleted, deleteItem, setToggleBtn, setNewToDo, setUpdateItem }) => {
    ...
    return (
        <div className="flex h-16 min-w-32 w-screen md:w-2/6 md:max-w-lg mx-2 my-4 justify-between font-medium hover:font-bold bg-blue-700 shadow-xl hover:shadow-2xl dark:shadow-none text-white px-5 py-5 rounded-full">
            {item.completed ?
