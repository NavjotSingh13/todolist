  ...
  return (
    <>
      <div className="flex justify-center h-1/6">
        <div>
          <input onChange={(e) => setNewToDo(e.target.value)} value={newTodo} type="text" placeholder='Enter a Todo' className='w-2/3 px-5 py-1 rounded-lg bg-white text-black ' />
          {toggleBtn ?
            <button onClick={editItem} className='bg-blue-200 hover:bg-blue-300 text-lg font-semibold px-2 py-1 mx-2 rounded-md'>Update</button> :
            <button onClick={addItemToDo} className='bg-blue-200 hover:bg-blue-300 text-lg font-semibold px-2 py-1 mx-2 rounded-md'>Add</button>
          }
        </div>
      </div>
